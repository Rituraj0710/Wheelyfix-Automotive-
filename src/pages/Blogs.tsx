...
const Blogs = () => {
  ...
  const blogs: BlogPost[] = [
    ...
    },
    {
      ...
      articleUrl: "https://en.wikipedia.org/wiki/Motorcycle_maintenance",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      articleUrl: "https://en.wikipedia.org/wiki/Maintenance,_repair,_and_operations",
    },
    {
      id: 5,
    ...
    },
    {
      ...
      articleUrl: "https://en.wikipedia.org/wiki/Electric_car",
    },
    {
      id: 8,
      title:
      ...
      articleUrl: "https://en.wikipedia.org/wiki/Vehicle_winterization",
    },
    {
      id: 9,
      ...
      articleUrl: "https://en.wikipedia.org/wiki/Motor_oil",
    },
  ];
                    ...
                    <div className="md:flex">
                      ...
                      <div className="md:w-1/2 p-6 md:p-8">
                        ...
                        <div className="mt-4 flex gap-3">
                          {filteredBlogs[0].articleUrl && (
                            <a
                              href={filteredBlogs[0].articleUrl}
                              target="_blank"
                          ...
                          <a
                            href={`https://www.youtube.com/results?search_query=${encodeURIComponent(filteredBlogs[0].title)}`}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-block"
                          >
                      ...
                      >
                        ...
                        <div className="p-6 flex flex-col flex-grow">
                          ...
                          <div className="mt-2 flex gap-3">
                            ...
                            <a
                              href={`https://www.youtube.com/results?search_query=${encodeURIComponent(blog.title)}`}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="inline-block"
                            >
